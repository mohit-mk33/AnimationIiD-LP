...
<head>
	...
	<link rel="icon" type="image/png" href="assets/images/course/favicon.png">
...
if(isset($_POST['email'])) { 
    ...
    $email_to = "Tgcanimation@gmail.com";
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Full Name: ".clean_string($phone)."\n";
...
header("location:https://www.tgcindia.com/thanks/") //changed to revert to thanks pg
?> 
<!-- SUCCESS MESSAGE -->
